...
export const Book = () => {
  ...
  const bookList = useAppSelector(state => state.gateway.book.entities);
  const loading = useAppSelector(state => state.gateway.book.loading);
  const totalItems = useAppSelector(state => state.gateway.book.totalItems);
      ...
      <h2 id="book-heading" data-cy="BookHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="gatewayApp.bookBook.home.refreshListLabel">Refresh List</Translate>
          </Button>
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayApp.bookBook.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
